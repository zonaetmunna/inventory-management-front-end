...
const EditPersonalAndContact = ({ supplierDetails, setSupplierDetails, brandList, branchList }) => {
	const {
		_id,
		name,
		gender,
	...
	return (
		<form className="font-medium" onSubmit={handleSubmit(onSubmit)}>
			...
			<Input
				...
				required="true"
			/>
			<Button title="Update" type="submit" isLoading={isLoading} isDisabled={isDisabled} />
		</form>
	);
};
