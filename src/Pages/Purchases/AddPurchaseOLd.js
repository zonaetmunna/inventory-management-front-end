						...
						<div>
							...
							<div className="bg-white">
								{fields.map((item, index) => (
									<div
										key={item.id}
										className="grid grid-cols-2 gap-4 border-b border-green-200 py-2 my-5 "
									>
										<MySelect
											id="brand"
											label="Brand"
											...
											rules={{
												...
												onChange: (e) => {
													...
													const totalBuyingPrice =
														parseInt(quantity, 10) * parseFloat(e.target.value);
										...
										<MyInput
											...
											rules={{
												...
												onChange: (e) => {
													...
													const totalBuyingPrice =
														parseFloat(buyingPrice) * parseInt(e.target.value, 10);
													const totalSellingPrice =
														parseFloat(sellingPrice) * parseInt(e.target.value, 10);
										...
										<MyInput
											...
											rules={{
												...
												onChange: (e) => {
													const quantity = getValues(`products.${index}.quantity`);
													const totalSellingPrice =
														parseFloat(e.target.value) * parseInt(quantity, 10);
													setValue(`products.${index}.totalSellingPrice`, totalSellingPrice);
												},
											}}
											errors={errors}
