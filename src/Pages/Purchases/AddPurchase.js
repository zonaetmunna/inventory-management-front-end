					...
					<form className="h-full py-3" onSubmit={handleSubmit(onSubmit)}>
						<div className="flex flex-wrap w-full gap-y-3">
								...
								<>
									...
									<div className="w-1/2 flex flex-col gap-1 px-3">
										...
										<Controller
											...
											control={control}
											render={({ field }) => (
												<ReactSelect isClearable {...field} options={units} styles={customeStyle} />
											)}
										/>
									</div>
									<div className="w-1/2 flex flex-col gap-1 px-3">
											...
											{...register(`products[${index}].quantity`, {
												...
												onChange: (e) => {
													...
													const buyingPrice = parseFloat(
														getValues(`products[${index}].buyingPrice`)
													);
									...
									<div className="w-1/2 flex flex-col gap-1 px-3">
										...
										<input
											className="im-input"
											{...register(`products[${index}].sellingPrice`, { valueAsNumber: true })}
											type="text"
											id="sellingPrice"
										/>
									</div>
							...
							<div className="w-full flex justify-end gap-3">
								<button className="btn btn-primary" type="button" onClick={handleAppendForm}>
									Add Product
								</button>
							</div>
