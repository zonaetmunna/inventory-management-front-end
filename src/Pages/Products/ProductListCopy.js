...
const ProductList = () => {
	...
	const tableHeader = ['No', 'Name', 'Category', 'Brand', 'Unit', 'Actios'];
			...
			<header className="font-medium  flex justify-between">
				...
				<div className="flex-col">
					<p className="flex align-center cursor-pointer">
						<TbAdjustmentsHorizontal className="" size={28} onClick={handleClearFilters} />
						<span className="text-md">Clear Filters</span>
					</p>
					<p className="bg-primary text-white py-2 px-4 mt-2">
						<button type="button" className="rounded" onClick={() => handleNavigate(addProductURL)}>
							Add Product
